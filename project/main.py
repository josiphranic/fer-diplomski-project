...
train_images, train_masks = load_and_preprocess_train_images_and_masks(root_dir + 'train', 'image', 'label')
evaluation_images, evaluation_masks = load_and_preprocess_evaluation_images_and_masks(root_dir + 'evaluation', 'image', 'label')
